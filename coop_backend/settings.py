"""
Django settings for coop_backend project.
...
ALLOWED_HOSTS = ['coop-bakend.herokuapp.com']
...
ROOT_URLCONF = 'coop_backend.urls'
...
WSGI_APPLICATION = 'coop_backend.wsgi.application'
